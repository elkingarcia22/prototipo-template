...
const BORDER_STATIC_INV_TOKENS = [
...
const meta: Meta = {
  title: 'Tokens/Colors/Border Colors - Static Inverted',
  tags: ['autodocs'],
};
export default meta;
...
function swatch(token: string, theme: 'light' | 'dark') {
  ...
  wrap.style.gridTemplateColumns = '500px 1fr';
  ...
  box.style.border = `2px solid ${value || '#9ca3af'}`;
