...
const SUCCESS_TOKENS = [
  '--ubits-feedback-bg-success-subtle','--ubits-feedback-fg-success-subtle','--ubits-feedback-accent-success','--ubits-feedback-accent-success-inverted',
  '--ubits-feedback-accent-success-static','--ubits-feedback-accent-success-static-inverted','--ubits-feedback-fg-success-subtle-alt','--ubits-feedback-fg-success-subtle-inverted',
  '--ubits-feedback-fg-success-subtle-hover','--ubits-feedback-fg-success-subtle-inverted-hover','--ubits-feedback-fg-success-subtle-static','--ubits-feedback-fg-success-subtle-static-inverted',
  '--ubits-feedback-fg-success-subtle-static-hover','--ubits-feedback-fg-success-subtle-static-inverted-hover'
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Feedback · Success',
  tags: ['autodocs'],
};
export default meta;
...
function swatch(token: string, theme: 'light' | 'dark') {
  ...
  wrap.style.gridTemplateColumns = '620px 1fr';
