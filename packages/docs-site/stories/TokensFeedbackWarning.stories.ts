...
const WARNING_TOKENS = [
  '--ubits-feedback-bg-warning-subtle','--ubits-feedback-fg-warning-subtle','--ubits-feedback-accent-warning','--ubits-feedback-accent-warning-inverted',
  '--ubits-feedback-fg-warning-subtle-alt','--ubits-feedback-fg-warning-subtle-inverted','--ubits-feedback-fg-warning-subtle-hover','--ubits-feedback-fg-warning-subtle-inverted-hover',
  '--ubits-feedback-fg-warning-bold','--ubits-feedback-fg-warning-bold-inverted','--ubits-feedback-fg-warning-bold-hover','--ubits-feedback-fg-warning-bold-inverted-hover',
  '--ubits-feedback-fg-warning-subtle-static','--ubits-feedback-fg-warning-subtle-static-inverted','--ubits-feedback-fg-warning-subtle-static-hover','--ubits-feedback-fg-warning-subtle-static-inverted-hover'
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Feedback · Warning',
  tags: ['autodocs'],
};
export default meta;
...
function swatch(token: string, theme: 'light' | 'dark') {
  ...
  wrap.style.gridTemplateColumns = '660px 1fr';
