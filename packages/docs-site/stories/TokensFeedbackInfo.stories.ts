...
const INFO_TOKENS = [
  '--ubits-feedback-bg-info-subtle','--ubits-feedback-fg-info-subtle','--ubits-feedback-accent-info','--ubits-feedback-accent-info-inverted',
  '--ubits-feedback-accent-info-static','--ubits-feedback-accent-info-static-inverted','--ubits-feedback-fg-info-subtle-alt','--ubits-feedback-fg-info-subtle-inverted',
  '--ubits-feedback-fg-info-subtle-hover','--ubits-feedback-fg-info-subtle-inverted-hover','--ubits-feedback-fg-info-subtle-static','--ubits-feedback-fg-info-subtle-static-inverted',
  '--ubits-feedback-fg-info-subtle-static-hover','--ubits-feedback-fg-info-subtle-static-inverted-hover'
] as const;

const meta: Meta = {
  title: 'Tokens/Colors/Feedback · Info',
  tags: ['autodocs'],
};
export default meta;
...
function swatch(token: string, theme: 'light' | 'dark') {
  ...
  wrap.style.gridTemplateColumns = '600px 1fr';
